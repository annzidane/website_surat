                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" id="nik" name="nik" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" required pattern="\d{16}" maxlength="16">
                                @error('nik')
                                    <span class="text-red-600">{{ $message }}</span>
                                @enderror
                            </div>
                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" id="nik_orang_tua" name="nik_orang_tua" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" required pattern="\d{16}" maxlength="16">
                                @error('nik_orang_tua')
                                    <span class="text-red-600">{{ $message }}</span>
                                @enderror
                            </div>
