                    ...
                    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            ...
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                ...
                                <td class="px-6 py-4">{{ $item->nama_anak }}</td>
                ...
                <template x-if="showPopup">
                    <div class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
                        <div class="bg-white rounded-lg p-6 w-full max-w-md mx-auto">
                            <h2 class="text-xl font-semibold mb-4">Detail Surat Kelahiran</h2>
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <p x-text="selectedData.tempat_dilahirkan" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm"></p>
                                    </div>
                                    <!-- Add more fields as needed -->
                                </div>
                                <div>
                                    <div class="mb-4">
                                        <label class="block font-medium text-gray-700">Tempat Kelahiran</label>
                                        <p x-text="selectedData.tempat_kelahiran" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm"></p>
                                    </div>
                                    <div class="mb-4">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <p x-text="selectedData.jam" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm"></p>
                                    </div>
                                    <!-- Add more fields as needed -->
                                </div>
                            </div>
